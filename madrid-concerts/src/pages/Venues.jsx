...
function venueStats(venueId, allEvents) {
...
export default function Venues() {
  const { venues: allVenues, events: allEvents } = useData()
  const venues = allVenues
    .map(v => ({ ...v, stats: venueStats(v.id, allEvents) }))
